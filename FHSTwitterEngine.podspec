#
#  Be sure to run `pod spec lint FHSTwitterEngine.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Quang Mai Van" => "quang.app@gmail.com" }
  # Or just: s.author    = "Quang Mai Van"
  # s.authors            = { "Quang Mai Van" => "quang.app@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Quang Mai Van"
